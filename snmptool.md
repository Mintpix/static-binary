...
./configure \
  ...
  LIBS="-lcrypto -lssl -lcrypt32 -lws2_32 -ladvapi32 -luser32"
...
for tool in snmpget snmpwalk snmpbulkwalk snmpbulkget snmpset snmpgetnext \
  ...
  gcc -static -O2 -D_GNU_SOURCE -o apps/$tool.exe apps/$tool.o \
    ...
    -lcrypto -lssl -lcrypt32 -lws2_32 -ladvapi32 -luser32 -liphlpapi -lsnmpapi
done
...
#   - -liphlpapi -lsnmpapi: net-snmp 在 Cygwin 下需要这两个 Windows 网络库
